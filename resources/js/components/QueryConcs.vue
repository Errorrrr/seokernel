                    ...
                    <div class="table-responsive">
                        <table id="recent-purchases-listing" class="table">
                            ...
                            <tr v-for="(query,index) in queries">
                                ...
                                <td>{{ query.date }}</td>
                                <td>
                                    <button type="button" class="btn btn-success btn-md" v-on:click="downloadExcel(query.query)">Excel</button>
    ...
    export default {
        ...
        methods: {
            downloadExcel: function(query) {
                window.location.replace("/api/download_excel/"+encodeURI(query));
            },
            deleteQuery: function(query, index) {
                axios
                    .post('/api/delete_query', {query:query})
                    .then((response) => {
